...
void obj_loader::vertex_cb(obj::float_type x, obj::float_type y, obj::float_type z)
{
  switch (this->LSculpt_args->OPTS_UP) {
    case UP_Z:
      vertices_.push_back(std::tuple<obj::float_type, obj::float_type, obj::float_type >(
...
void obj_loader::face_cb_v(obj::index_type v1, obj::index_type v2, obj::index_type v3)
{
  ...
  this->LSculpt_mesh->back().v[0] = SmVector3(std::get<0>(vertices_[v1 - 1]),std::get<1>(vertices_[v1 - 1]),std::get<2>(vertices_[v1 - 1]));
  this->LSculpt_mesh->back().v[1] = SmVector3(std::get<0>(vertices_[v2 - 1]),std::get<1>(vertices_[v2 - 1]),std::get<2>(vertices_[v2 - 1]));
  this->LSculpt_mesh->back().v[2] = SmVector3(std::get<0>(vertices_[v3 - 1]),std::get<1>(vertices_[v3 - 1]),std::get<2>(vertices_[v3 - 1]));
}
...
{
  this->face_cb_v(std::get<0>(v1_vt1),std::get<0>(v2_vt2),std::get<0>(v3_vt3));
}
...
{
  this->face_cb_v(std::get<0>(v1_vn1),std::get<0>(v2_vn2),std::get<0>(v3_vn3));
}
...
{
  this->face_cb_v(std::get<0>(v1_vt1_vn1),std::get<0>(v2_vt2_vn2),std::get<0>(v3_vt3_vn3));
}
...
bool obj_loader::convert(std::istream& istream, std::vector<Triangle>& mesh, ArgumentSet& args)
{
  ...
  obj_parser.info_callback(std::bind(&obj_loader::info_cb, this, ifilename, _1, _2));
  obj_parser.warning_callback(std::bind(&obj_loader::warning_cb, this, ifilename, _1, _2));
  obj_parser.error_callback(std::bind(&obj_loader::error_cb, this, ifilename, _1, _2));

  obj_parser.geometric_vertex_callback(std::bind(&obj_loader::vertex_cb, this, _1, _2, _3));
  obj_parser.face_callbacks(
    std::bind(&obj_loader::face_cb_v, this, _1, _2, _3),
    std::bind(&obj_loader::face_cb_v_vt, this, _1, _2, _3),
    std::bind(&obj_loader::face_cb_v_vn, this, _1, _2, _3),
    std::bind(&obj_loader::face_cb_v_vt_vn, this, _1, _2, _3),
