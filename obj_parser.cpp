          ...
          if (stringstream.peek() != '/') {
            ...
            if (std::isspace(stringstream.peek())) {
              ...
              if (((v1 < index_type(-number_of_geometric_vertices)) || (-1 < v1)) && ((v1 < 1) || (index_type(number_of_geometric_vertices) < v1))
               ...
               || ((v3 < index_type(-number_of_geometric_vertices)) || (-1 < v3)) && ((v3 < 1) || (index_type(number_of_geometric_vertices) < v3))) {
                if (error_callback_) {
                  error_callback_(line_number, "vertex index out of bounds");
                }
                return false;
              }

			  treat_vt_as_vn = false;
              if (((vt1 < -index_type(number_of_texture_vertices)) || (-1 < vt1)) && ((vt1 < 1) || (index_type(number_of_texture_vertices) < vt1))
               ...
               || ((vt3 < -index_type(number_of_texture_vertices)) || (-1 < vt3)) && ((vt3 < 1) || (index_type(number_of_texture_vertices) < vt3))) {
				// reinterpret texture indices as normal vertex (assumming malformed v/vn instead of v//vn)
	            if (((vt1 < -index_type(number_of_vertex_normals)) || (-1 < vt1)) && ((vt1 < 1) || (index_type(number_of_vertex_normals) < vt1))
				 || ((vt2 < -index_type(number_of_vertex_normals)) || (-1 < vt2)) && ((vt2 < 1) || (index_type(number_of_vertex_normals) < vt2))
				 || ((vt3 < -index_type(number_of_vertex_normals)) || (-1 < vt3)) && ((vt3 < 1) || (index_type(number_of_vertex_normals) < vt3))) {
			      // still failed
	              if (error_callback_) {
                    error_callback_(line_number, "texture vertex index out of bounds");
                  }
                  return false;
				} else {
                  if (warning_callback_) {
                    warning_callback_(line_number, "texture vertex index out of bounds, treating as vertex normal index instead");
                  }
			      treat_vt_as_vn = true;  
				}
              }
              if (flags_ & translate_negative_indices) {
				...
				if (treat_vt_as_vn) {
				  if (vt1 < 0) {
					vt1 += number_of_vertex_normals + 1;
				  }
				  if (vt2 < 0) {
                    vt2 += number_of_vertex_normals + 1;
				  }
				  if (vt3 < 0) {
                    vt3 += number_of_vertex_normals + 1;
	              }
				} else {
				  if (vt1 < 0) {
              ...
              if (stringstream.eof()) {
                ...
                if (!treat_vt_as_vn && (((vt4 < -index_type(number_of_texture_vertices)) || (-1 < vt4)) && ((vt4 < 1) || (index_type(number_of_texture_vertices) < vt4)))) {
                  if (error_callback_) {
                    error_callback_(line_number, "texture vertex index out of bounds");
                  }
                  return false;
                }
                if (treat_vt_as_vn && (((vt4 < -index_type(number_of_vertex_normals)) || (-1 < vt4)) && ((vt4 < 1) || (index_type(number_of_vertex_normals) < vt4)))) {
                  if (error_callback_) {
                    error_callback_(line_number, "vertex normal index out of bounds");
                  }
                  return false;
                }
                if (flags_ & translate_negative_indices) {
                  ...
                  if (treat_vt_as_vn) {
					if (vt4 < 0) {
					  vt4 += number_of_vertex_normals + 1;
					}
				  } else {
					if (vt4 < 0) {
                  ...
                  if (flags_ & triangulate_faces) {
                    ...
                    do {
                      ...
                      if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && std::isspace(whitespace_vt_v)) {
						...
						if (!treat_vt_as_vn && (((vt < -index_type(number_of_texture_vertices)) || (-1 < vt)) && ((vt < 1) || (index_type(number_of_texture_vertices) < vt)))) {
						  if (error_callback_) {
							error_callback_(line_number, "texture vertex index out of bounds");
						  }
						  return false;
						}
						if (treat_vt_as_vn && (((vt < -index_type(number_of_vertex_normals)) || (-1 < vt)) && ((vt < 1) || (index_type(number_of_vertex_normals) < vt)))) {
						  if (error_callback_) {
							error_callback_(line_number, "vertex normal index out of bounds");
						  }
						  return false;
					...
					if (treat_vt_as_vn) {
					  if (polygonal_face_geometric_vertices_vertex_normals_begin_callback_) {
						polygonal_face_geometric_vertices_vertex_normals_begin_callback_(index_2_tuple_type(v1, vt1), index_2_tuple_type(v2, vt2), index_2_tuple_type(v3, vt3));
					  }
					  if (polygonal_face_geometric_vertices_vertex_normals_vertex_callback_) {
						polygonal_face_geometric_vertices_vertex_normals_vertex_callback_(index_2_tuple_type(v4, vt4));
					  }
					} else {
                    ...
                    do {
                      ...
                      if (stringstream && (slash_geometric_vertices_texture_vertices == '/') && std::isspace(whitespace_vt_v)) {
                        ...
                        if (!treat_vt_as_vn && polygonal_face_geometric_vertices_texture_vertices_vertex_callback_) {
                          polygonal_face_geometric_vertices_texture_vertices_vertex_callback_(index_2_tuple_type(v, vt));
                        }
                        if (treat_vt_as_vn && polygonal_face_geometric_vertices_vertex_normals_vertex_callback_) {
                          polygonal_face_geometric_vertices_vertex_normals_vertex_callback_(index_2_tuple_type(v, vt));
                        }
                      }
                    }
                    while (stringstream && !stringstream.eof());
                    ...
                    ++number_of_faces;
                    if (!treat_vt_as_vn && polygonal_face_geometric_vertices_texture_vertices_end_callback_) {
                      polygonal_face_geometric_vertices_texture_vertices_end_callback_();
                    }
                    if (treat_vt_as_vn && polygonal_face_geometric_vertices_vertex_normals_end_callback_) {
